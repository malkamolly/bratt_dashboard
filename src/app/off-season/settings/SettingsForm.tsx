        ...
        <fieldset key={s.id} className="bt-card !p-5">
          ...
          <div className="space-y-4">
            {s.targets.map((t) => (
              <div
                key={t.workType}
                className="rounded-2 border-2 border-paper-edge bg-white/60 p-4"
              >
                ...
                <div className="mt-3 grid grid-cols-1 gap-3 sm:grid-cols-3">
                  <label className="flex flex-col gap-1">
                    ...
                    <input
                      type="text"
                      inputMode="decimal"
                      name={`goal__${s.id}__${t.workType}`}
                  ...
                  <label className="flex flex-col gap-1">
                    ...
                    <input
                      type="date"
                      name={`start__${s.id}__${t.workType}`}
