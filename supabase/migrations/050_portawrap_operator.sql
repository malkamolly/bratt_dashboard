...
stat: 200–400
stat-caption: pounds — the **light** practice loads you learn on, in a safe and unoccupied zone, until you understand how wraps control weight.
source: Source: Notch Equipment Portawrap instructions
panel-title: Before you ever run a real load
- **Get trained**, then practice with light loads in a safe, unoccupied area
