-- ============================================================================
-- 033_normalize_crew_member_names.sql
-- ============================================================================
...
--
-- Also fixes Sean-Paul's name in field_crew_employees, which earlier seed
-- data stored as "Sean Paul M" (no hyphen) -- his actual first name is
-- hyphenated.
-- ============================================================================

-- ---------------------------------------------------------------------------
-- crew_members: people already in field_crew_employees -> match the canonical
-- "First L" name used there.
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- crew_members: people NOT in field_crew_employees -- shorten their full
-- name to "First L" (PHC, Stump Grinding, Clam, Other; plus the salesperson
-- who also has a crew_members row).
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- field_crew_employees: restore the hyphen in Sean-Paul's name.
-- ---------------------------------------------------------------------------
